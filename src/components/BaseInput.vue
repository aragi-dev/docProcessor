  ...
  <div class="grid">
    ...
    <div class="relative">
      <input :type="props.type" :name="props.name" :id="props.name"
        ...
        :class="['py-2 px-4 rounded-2xl text-white shadow-lg border border-white/20 backdrop-blur-sm bg-gradient-to-br from-white/10 to-white/5 transition w-full duration-300 focus:outline-none focus:from-white/20 focus:to-white/10 focus:border-white/30 disabled:opacity-0', props.inputClass]" />
